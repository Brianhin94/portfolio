...
export default function Project() {
  ...
  return (
    <main className="bg-coolGray-400 min-h-screen p-12 margin">
      <section className="container mx-auto">
        <h1 className="text-4xl bg-coolGray-400 flex justify-center cursive">My Projects</h1>
          ...
          {projectData &&
            projectData.map((project, index) => (
              <article className="relative mx-auto rounded-lg shadow-xl bg-coolGray-400 p-10 pl-4">
                ...
                <div className=" text-green-400 text-xs space-x-4">
                  <span>
                  ...
                  <p className=" my-6 text-lg text-green-400 leading-relaxed">
                    {project.description}
                  </p>
                  <a
                    href={project.link}
